# [Hospa Hospital Mangement System - By Henry Asante( CriiscentSoft ) ]
This software was started somewhere from August 2018. This is my second major sofware that contains feature rich functionality.
Anyone holding this software should know it was written by a 19 year old. Nothing is impossible for you, and such you have been
given the free will to use this software for whatever you want, though credit should be given to me to increase my chances of 
gaining an audeince for my next softwares to come.
...
// problems 
// users from another hospital can't have other hospital data
// super admin decides which hospital modules can be used by an individual
// by defualt some modules would be hidden by role

-- so therefore  id will entail of the user id and hospital id
